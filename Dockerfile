...
ENV SCRIPT="gitlab_jobs_logs_downloader.py"
ENV USERNAME="gitlab"
ENV UID="1000"
ENV GID="1000"
ENV VIRTUAL_ENV="/gitlab-jobs-logs-downloader"
...
USER ${USERNAME}
WORKDIR ${VIRTUAL_ENV}
HEALTHCHECK CMD curl -s -f -H "PRIVATE-TOKEN: ${CI_API_TOKEN}" "${CI_API_V4_URL}/version"
